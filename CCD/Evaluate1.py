...
import os
import time
from getNumberClusters import getNumberBySparseness, detectCommunitiesSNMF
...
#     from multicom import multicom, approximate_ppr, conductance_sweep_cut, load_graph
    ...
    seeds, communities = multicom(adj_matrix, seed, approximate_ppr, conductance_sweep_cut, explored_ratio=.8)
    return communities
